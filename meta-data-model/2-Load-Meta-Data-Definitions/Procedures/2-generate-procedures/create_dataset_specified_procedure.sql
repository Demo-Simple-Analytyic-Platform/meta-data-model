CREATE PROCEDURE deployment.create_dataset_specified_procedure
...
BEGIN
  ...
  IF (1=1 /* Build SQL Statemen for creation of "Stored Procedure" */) BEGIN
    ...
    SET @tx_sql += @nwl + '/* !!! deployment.create_dataset_specified_procedure, see example here below.               !!! */'
    SET @tx_sql += @nwl + '/* !!!                                                                            !!! */'
    SET @tx_sql += @nwl + '/* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */'
    SET @tx_sql += @nwl + '/* ' 
    SET @tx_sql += @nwl + '-- Example for `Generation of ' + @nm_data_flow_type + ' Procedure`:'
    SET @tx_sql += @nwl + 'EXEC deployment.create_dataset_specified_procedure'
